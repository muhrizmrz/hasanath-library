    ...
    <div className="">
      <div className="w-1/4 bg-gray-100 border-2 p-6 mx-auto my-24">
        <div className="text-center">
          <h1 className="text-gray-600 font-bold text-2xl font-serif">
            Hasanath Library
          </h1>
          ...
          <form onSubmit={(e) => handleLogin(e)}>
            <div class="grid grid-cols-1 space-y-2 col-span-2 mt-12">
              <input
                ...
                class="text-gray-700 p-2 bg-gray-200 rounded border-gray-300 focus:outline-none focus:bg-blue-100"
              />
            </div>
            ...
            <button
              type="submit"
              className="p-2 px-4 w-full bg-blue-500 mt-2 text-white rounded-md"
            >
              Login
            </button>
          </form>
