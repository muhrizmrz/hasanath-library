                ...
                <p
                  className={
                    obj.isactiveFirstSummary
                      ? "text-xl  px-8 py-2 cursor-pointer bg-blue-600 mb-2 capitalize text-white"
                      : "text-xl text-gray-500  px-8 py-2 cursor-pointer hover:text-white rounded-lg mb-2 capitalize"
                  }
                  key={obj._id.$oid}
